...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='./fcis-asu-autism-disorder-classification/train/train',
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='acgpn',
        ...
        parser.add_argument('--nrf', type=int, default=64, help='# of discrim filters in the first conv layer')
        parser.add_argument('--nuf', type=int, default=64, help='# of discrim filters in the first conv layer')
        ...
        parser.add_argument('--dropout_rate', type=float, default=0, help='no dropout for the generator')
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='acgpn',
